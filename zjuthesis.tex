...
\documentclass[
    ...
    Title           = 基于强化学习的足式移动操作平台全身控制方法,
    TitleEng        = {{Reinforcement Learning Based Whole-Body Control for Legged Manipulator}}
]{zjuthesis}
...
% \titletwolines{基于物理启发式强化}{学习的全身控制方法}
\titletwolines{基于强化学习的足式移动}{操作平台全身控制方法}
% \titleengtwolines{English Title Line One}{English Title Line Two}

% \titlethreelines{毕业论文题目第一行}{毕业论文题目第二行}{毕业论文题目第三行}
% \titleengthreelines{Physics Informed}{Reinforcement Learning for}{Whole-Body Control}
\titleengthreelines{Reinforcement Learning}{Based Whole-Body Control}{for Legged Manipulator}
...
\newcommand{\inputgraduate}
{
    ...
    {
        \coverstyle
        \inputpage{proposal_cover1}
        % \prevstyle
        % \inputpage{previous}
        % \inputpage{toc}
        % Main contents
        \bodystyle
        \inputbody{proposal_content}
        % Post part
        % \poststyle
        % \inputbody{post}
        }{}
